...
class TestMotorOverheat:
    ...
    def send_motor_overheat(self, mqtt_ops):
        """Send motor overheat alarm."""
        print("\n🔥 Sending motor overheat alarm")
        mqtt_ops.mqtt_client.publish("s/us", f"301,{self.config['test']['alarm_type']}")
    ...
    def test_m1_ma0_oh1_alarm_expected(self, mqtt_ops):
        ...
        self.send_motor_overheat(mqtt_ops)
    ...
    def test_m1_ma0_oh1_multiple_signals_alarm_expected(self, mqtt_ops):
        ...
        # Set up conditions
        self.send_measurement(mqtt_ops, "motor-state", "motor-state", 1)
        self.sleep_between_commands()
        
        self.send_measurement(mqtt_ops, "maintenance-mode", "maintenance-mode", 0)
        self.sleep_between_commands()
